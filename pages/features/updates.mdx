...
## Removed Pull pattern

- Sending funds through a proposal no longer requires a second step of the receiver 'withdrawing' funds
- Ragequit no longer requires a second step of the member 'withdrawing' funds
...
- Tribute Minion is a safe way for a new member to make a tribute to the dao for shares/loot
- Onboarder Shaman allows permissionless onboarding into loot
